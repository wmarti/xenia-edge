...
class ExecutionJitCorpus {
 public:
  ...
  static constexpr uint32_t kMaxDeclarationRecords = 1024;
...
class ExecutionJitCorpusBuilder {
 public:
  ...
  bool AddDeclaration(const ExecutionJitCorpus::DeclarationRecord& saverest,
                      std::string* error = nullptr);
  ...
  size_t declaration_count() const { return declaration_records_.size(); }
 ...
 private:
  ...
  std::vector<ExecutionJitCorpus::DeclarationRecord> declaration_records_;
